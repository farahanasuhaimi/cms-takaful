...
class PlanProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                'plan_type' => 'medical',
                'name'      => 'A-Plus Health360-i (Plan 200)',
                'attributes' => [
                    'Type'               => 'Medical Card — Rider (Hospital & Surgical)',
                    'Produk Utama'       => 'Rider kepada A-Life Idaman atau pelan takaful keluarga berkala',
                    'Room & Board'       => 'RM200/malam | Gold: +50% → RM300 | Platinum: +100% → RM400',
                    'Coverage'           => 'RM1,500,000/tahun | Tiada had seumur hidup',
                    'Deductible'         => 'RM500/tahun | atau RM500 + SMART Option (diskaun min 20%)',
                    'Ko-Takaful'         => '5% (rawatan & fisioterapi pesakit luar), had RM500/tahun',
                    'Health Wallet NCB'  => 'RM1,000/tahun (max 10x) — jika tiada tuntutan',
                    'Panel Bonus'        => 'RM500/tahun (max 10x) — jika rawatan di Hospital Panel SMART',
                    'Mental Health'      => 'RM1,500/tahun via Health Wallet — 6 keadaan psikiatri',
                    'Recovery Care'      => 'Kanser, Strok, Serangan Jantung — via Health Wallet',
                    'AIA Vitality'       => 'Optional RM10/bulan — bonus hospitalisasi, naik taraf bilik, booster wallet',
                    'PMCM'               => 'Ya — Teladoc (pengurusan kes perubatan peribadi)',
            ...
            [
                'plan_type' => 'medical',
                'name'      => 'A-Plus Health360-i (Plan 300)',
                'attributes' => [
                    'Type'               => 'Medical Card — Rider (Hospital & Surgical)',
                    'Produk Utama'       => 'Rider kepada A-Life Idaman atau pelan takaful keluarga berkala',
                    'Room & Board'       => 'RM300/malam | Gold: +50% → RM450 | Platinum: +100% → RM600',
                    'Coverage'           => 'RM3,000,000/tahun | Tiada had seumur hidup',
                    'Deductible'         => 'RM500/tahun | atau RM500 + SMART Option (diskaun min 20%)',
                    'Ko-Takaful'         => '5% (rawatan & fisioterapi pesakit luar), had RM500/tahun',
                    'Health Wallet NCB'  => 'RM2,500/tahun (max 10x) — jika tiada tuntutan',
                    'Panel Bonus'        => 'RM1,000/tahun (max 10x) — jika rawatan di Hospital Panel SMART',
                    'Penjagaan Primer'   => 'RM1,000/2 tahun (pemeriksaan + vaksin + GP RM50/lawatan, max 3x/tahun)',
                    'Bonus Persaraan'    => 'Silver RM500 | Gold RM800 | Platinum RM1,000 /tahun — pindah ke PAF dari umur 60/tahun sijil ke-10',
                    'Komplikasi Hamil'   => 'Sehingga RM10,000 seumur hidup',
                    'Sokongan Optik'     => 'Kanta intraokular sehingga RM7,000 seumur hidup',
                    'Mental Health'      => 'RM1,500/tahun via Health Wallet — 6 keadaan psikiatri',
                    'Recovery Care'      => 'Kanser, Strok, Serangan Jantung — via Health Wallet',
                    'AIA Vitality'       => 'Optional RM10/bulan — bonus hospitalisasi, naik taraf bilik, booster wallet',
                    'PMCM'               => 'Ya — Teladoc (pengurusan kes perubatan peribadi)',
                ...
                'attribute_options' => [
                    'Deductible'   => ['RM500/tahun (standard)', 'RM500 + SMART Option (diskaun min 20%)'],
                    'Room & Board' => ['RM300/malam', 'RM450/malam (Gold)', 'RM600/malam (Platinum)'],
                ],
                'notes' => 'Medical card rider premium AIA PUBLIC Takaful. Had tahunan RM3M, tiada had seumur hidup. Health Wallet NCB RM2,500/tahun (max 10x) + Panel Bonus RM1,000/tahun. Penjagaan primer: GP, pemeriksaan kesihatan, vaksin RM1,000/2 tahun. Bonus Persaraan Sihat sehingga RM1,000/tahun (AIA Vitality Platinum) dipindah ke Dana Akaun Peserta. Perlindungan komplikasi kehamilan RM10K + kanta intraokular RM7K. PMCM via Teladoc untuk kes serius. Contoh caruman: lelaki 30 thn bukan perokok + A-Life Idaman RM30K, SMART Option = RM239.73/bulan (caruman gabungan).',
            ],
            // ── Hibah / Legacy ────────────────────────────────────────────────────
            [
                'plan_type' => 'hibah',
            ...
            [
                'plan_type' => 'medical',
                'name'      => 'Idaman Health Flex-i',
                'attributes' => [
                    'Type'               => 'Medical Card — Rider (Hospital & Surgical)',
                    'Produk Utama'       => 'Rider kepada A-Life Idaman (pelan takaful keluarga)',
                    'Room & Board'       => 'Fleksibel mengikut pilihan plan',
                    'Coverage'           => 'Mengikut plan yang dipilih | Tiada had seumur hidup',
                    'Kenaikan'           => 'Annual renewal',
                    'Waiver'             => 'yes (A-Plus WaiverExtra-i: 44 CI atau TPD)',
                ],
                'attribute_options' => [
                    'Room & Board' => ['Ikut plan pilihan'],
                ],
                'notes' => 'Medical card rider yang digabungkan dengan A-Life Idaman sebagai pelan asas. Sesuai untuk perlindungan perubatan fleksibel dengan komponen simpanan + hibah dari Idaman.',
            ],
            [
                'plan_type' => 'hibah',
