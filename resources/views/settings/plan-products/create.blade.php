<x-app-layout>
    <x-slot name="title">Register Plan · Dr Takaful CMS</x-slot>
    <x-slot name="pageTitle">Register Plan Product</x-slot>

    <div class="max-w-lg">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <form method="POST" action="{{ route('plan-products.store') }}">
                @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="plan_type" name="plan_type" required
                                    class="w-full text-sm rounded-lg border-gray-300 focus:ring-matcha-400 focus:border-matcha-400 @error('plan_type') border-red-400 @enderror">
                            ...
                            @error('plan_type') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required
                                   placeholder="e.g. A-Plus Med 350"
