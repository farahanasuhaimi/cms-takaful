<x-app-layout>
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div x-data="{ confirm: false }">
                        ...
                        <div x-show="confirm" class="flex items-center gap-2">
                            ...
                            <button type="submit" form="delete-lead-form" class="text-xs text-strawberry-600 font-medium hover:underline">Yes</button>
    ...
    <!-- Hidden delete form -->
    <form id="delete-lead-form" method="POST" action="{{ route('leads.destroy', $lead) }}" class="hidden">
        @csrf
        @method('DELETE')
    </form>
